...
import com.activiti.bpmn.manager.ProcessInstanceManager;
...
public class ProcessInstanceServiceImpl implements ProcessInstanceService {
     ...
     * Desc：创建流程实例，开始一个流程
     *
     * @param processDefinitionKey 流程定义name
     * @param businessKey           businessKey代表一份业务数据的标识(businessKey)
     */
    @Override
    public void createProcessInstance(String processDefinitionKey, String businessKey) {
        processInstanceManager.createProcessInstance(processDefinitionKey, businessKey);
    }
     ...
     * @description
     * @author zhjf
     * @updateTime 2022/8/11 9:51
     * @param	processDefinitionKey	bpmn文件processKey
    ...
    public ProcessInstance createProcessInstance(String processDefinitionKey, String businessKey, Map<String, Object> variables) {
        return processInstanceManager.createProcessInstance(processDefinitionKey,businessKey,variables);
    }
