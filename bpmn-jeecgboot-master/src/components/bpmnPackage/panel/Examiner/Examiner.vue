    ...
    <div class="panel-tab__content">
        <a-form-model :label-col="labelCol" :wrapper-col="wrapperCol">
            <a-form-model-item label="类型">
                <a-select
                    ref="select"
                    v-model:value="userTaskForm.type"
                >
                    <a-select-option v-for="(item,index) in userTaskTypeList" :value="item.value" :key="item.value">{{ item.label }}</a-select-option>
                </a-select>
            </a-form-model-item>
            <a-form-model-item label="处理人" v-if="userTaskForm.type == 'assignee'">
                <a-input
            ...
            <a-form-model-item label="候选用户" v-if="userTaskForm.type == 'candidateUsers'">
                <a-input
            ...
            <a-form-model-item label="候选角色" v-if="userTaskForm.type == 'candidateGroups'">
                <a-input
    ...
    data() {
        return {
            ...
            userTaskTypeList:[
                ...
                {value:'candidateUsers',label:'候选用户'},
                {value:'candidateGroups',label:'候选角色'}
            ]
        }
    },
    watch: {
        ...
        handleOk() {
            ...
            if (checkboxType === 'radio') {
                ...
                if (this.dialogType === 'role') {
                    let arr = selectedRows.map((item) => item.roleName)
                    this.userTaskForm[modalType] = arr.length ? `${this.userTaskForm[modalType]}${this.userTaskForm[modalType] ? ',' : ''}${arr.join(',')}` : this.userTaskForm[modalType]
                }
